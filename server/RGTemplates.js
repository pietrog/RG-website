...
function _load_demi(socket) {
    Player.remove({}, () => {
	Goal.remove({}, () => {
	    Player.remove({}, () => {
		Team.remove({}, () => {
		    Party.remove(() => {
			Party.create({name: "Airsoft League Demi Finale", started: true}, (err, party) => {
									  ...
									  Player.addToTeam(p4._id, t2._id, ()=>{
										  ...
										  Player.addToTeam(p6._id, t3._id, ()=>{
											  ...
											  Player.addToTeam(p8._id, t4._id, ()=>{
											      ...
											      Goal.create(
												  //secteur V
												  {name: '1.1', code: '1.1', label: "1 - Secteur V",  number_of_points: 400, compteur: 1},
												  {name: '1.2', code: '1.2', label: "1 - Secteur V", number_of_points: 400, compteur: 1},
												  {name: '1.3', code: '1.3', label: "1 - Secteur V", number_of_points: 400, compteur: 1},
												  {name: '1.4', code: '1.4', label: "1 - Secteur V", number_of_points: 400, compteur: 1},
												  {name: '1.5', code: '1.5', label: "1 - Secteur V", number_of_points: 400, compteur: 1},
												  {name: '1.6', code: '1.6', label: "1 - Secteur V", number_of_points: 400, compteur: 1},
												  {name: '1.7', code: '1.7', label: "1 - Secteur V", number_of_points: 400, compteur: 1},
												  {name: '1.8', code: '1.8', label: "1 - Secteur V", number_of_points: 400, compteur: 1},
												  {name: '1.9', code: '1.9', label: "1 - Secteur V", number_of_points: 400, compteur: 1},

												  //zero
												  {name: '2.1', code: '2.1', label: "2 - Zero", number_of_points: 400, compteur: 1},
												  {name: '2.2', code: '2.2', label: "2 - Zero", number_of_points: 400, compteur: 1},
												  {name: '2.3', code: '2.3', label: "2 - Zero", number_of_points: 400, compteur: 1},
												  {name: '2.4', code: '2.4', label: "2 - Zero", number_of_points: 400, compteur: 1},
												  {name: '2.5', code: '2.5', label: "2 - Zero", number_of_points: 400, compteur: 1},
												  {name: '2.6', code: '2.6', label: "2 - Zero", number_of_points: 400, compteur: 1},
												  
												  //camps mili
												  {name: '3.1', code: '3.1', label: "3 - Camps mili", number_of_points: 400, compteur: 1},
												  {name: '3.2', code: '3.2', label: "3 - Camps mili", number_of_points: 400, compteur: 1},
												  {name: '3.3', code: '3.3', label: "3 - Camps mili", number_of_points: 400, compteur: 1},
												  {name: '3.4', code: '3.4', label: "3 - Camps mili", number_of_points: 400, compteur: 1},
												  {name: '3.5', code: '3.5', label: "3 - Camps mili", number_of_points: 400, compteur: 1},
												  {name: '3.6', code: '3.6', label: "3 - Camps mili", number_of_points: 400, compteur: 1},
												  {name: '3.7', code: '3.7', label: "3 - Camps mili", number_of_points: 400, compteur: 1},
												  {name: '3.8', code: '3.8', label: "3 - Camps mili", number_of_points: 400, compteur: 1},
												  {name: '3.9', code: '3.9', label: "3 - Camps mili", number_of_points: 400, compteur: 1},
												  
												  //lost
												  {name: '4.1', code: '4.1', label: "4 - Lost", number_of_points: 400, compteur: 1},
												  {name: '4.2', code: '4.2', label: "4 - Lost", number_of_points: 400, compteur: 1},
												  {name: '4.3', code: '4.3', label: "4 - Lost", number_of_points: 400, compteur: 1},
												  {name: '4.4', code: '4.4', label: "4 - Lost", number_of_points: 400, compteur: 1},
												  {name: '4.5', code: '4.5', label: "4 - Lost", number_of_points: 400, compteur: 1},
												  {name: '4.6', code: '4.6', label: "4 - Lost", number_of_points: 400, compteur: 1},

												  //fort
												  {name: '5.1', code: '5.1', label: "5 - Fort", number_of_points: 400, compteur: 1},
												  {name: '5.2', code: '5.2', label: "5 - Fort", number_of_points: 400, compteur: 1},
												  {name: '5.3', code: '5.3', label: "5 - Fort", number_of_points: 400, compteur: 1},
												  {name: '5.4', code: '5.4', label: "5 - Fort", number_of_points: 400, compteur: 1},
												  {name: '5.5', code: '5.5', label: "5 - Fort", number_of_points: 400, compteur: 1},
												  {name: '5.6', code: '5.6', label: "5 - Fort", number_of_points: 400, compteur: 1},
												  ...
												  , (err) => {
												      RGProps.set_active_template('Airsoft League Demi Finale');
												      socket.emit('get_active_template', 'Airsoft League Demi Finale');
												  }																  
											      );
											  });
										      });
